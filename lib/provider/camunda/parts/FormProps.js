    ...
    entryFactory.comboBox({
      ...
      set: function (element, values, node) {
        ...
        if (values.type === 'string') {
          ...
          let properties = elementHelper.createElement(
            'camunda:Properties',
            {},
            getBusinessObject(element),
            bpmnFactory
          ...
          commands.push(
            cmdHelper.addElementsTolist(element, selectedFormField, 'values', [
              properties,
            ])
          );
          ...
          commands.push(
            cmdHelper.addElementsTolist(element, properties, 'values', [
              property,
            ])
          );
        } else {
    ...
    entryFactory.comboBox(
      {
        ...
        set: function (element, values, node) {
          ...
          if (selectedFormField.values) {
            ...
            var currentType = (selectedFormField.properties.values[0].value =
              values.type);
        ...
        hidden: function (element, node) {
          ...
          if (selectedFormField && selectedFormField.type === 'string') {
            let selectTypeString = document.getElementById(
              'camunda-form-field-string-values-select'
            );
