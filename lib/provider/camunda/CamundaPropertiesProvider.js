...
function createElementTemplateGroups(element, bpmnFactory, elementTemplates, modeling, replace, selection, translate) {
...
function CamundaPropertiesProvider(
  ...
  this.getTabs = function(element) {
    ...
    // Only show element template tab if element template applied
    if (getTemplateId(element)) {
      return [{
        id: 'element-template',
        label: translate('Element Template'),
        groups: createElementTemplateGroups(element, bpmnFactory, elementTemplates, modeling, replace, selection, translate)
      }];
    }
